        ...
        <div className="mt-8 grid grid-cols-1 gap-5 lg:grid-cols-3">
          ...
          <Card className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
            ...
            <CardFooter className="bg-gray-50 dark:bg-gray-700 px-5 py-3">
              <Button className="w-full">Crear nuevo presupuesto</Button>
            </CardFooter>
          </Card>
          ...
          <Card className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
            ...
            <CardFooter className="bg-gray-50 dark:bg-gray-700 px-5 py-3">
              <Button className="w-full">Añadir nueva meta</Button>
            </CardFooter>
          </Card>
          ...
          <Card className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
            ...
            <CardFooter className="bg-gray-50 dark:bg-gray-700 px-5 py-3">
              <Button className="w-full">Registrar transacción</Button>
            </CardFooter>
          </Card>
        </div>
      </div>
